...
3. Why is it useful? Many sites need a manual theme toggle (e.g., a sun/moon button) rather than relying solely on OS preference. The `[data-theme]` selector gives developers a standard hook for JS-driven theme switching while keeping all CSS variables in one place.
